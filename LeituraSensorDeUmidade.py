...
def ler_dados_do_serial(porta_serial):
    ...
    with serial.Serial(porta_serial, 115200) as ser:
        while True:
            ...
            if len(dados) >= 5000:  # Para o exemplo, vamos salvar 1000 linhas de dados em CSV
                break
    return dados
...
if __name__ == '__main__':
    ...
    salvar_dados_em_csv(dados_recebidos, 'dados_do_arduino_Novos.csv') # Salvando os arquivos em CSV